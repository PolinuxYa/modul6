...
/// Режим фильтрации при чтении логов
...
pub enum ReadMode {
    ...
    /// Только ошибки
    Errors,
    /// Только операции с активами (купить/продать/и т.д.)
    Exchanges,
}
...
pub fn read_log<R: std::io::Read>(input: R, mode: ReadMode, request_ids: &[u32]) -> Vec<LogLine> {
